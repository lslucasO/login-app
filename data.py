...
def main_Screen():
    ...
    def frame():
        ...
        img_label = customtkinter.CTkLabel(master=frame_1, image=img_tk, text="", bg_color="white")
    ...
    def login_Button():
        ...
        login_btn = customtkinter.CTkButton(window, text="Entrar", command=new_Frame, font=("Roboto", 17),width=220, corner_radius=20)
